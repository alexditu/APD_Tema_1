...
int main (int argc, char **argv) {
	...
	for (s = 0; s < S; s++) {
		...
		// fiecare thread primeste cate un chunk de linii de procesat
		...
		for (i = 0; i < N; i++) {
			for (j = 0; j < N; j++) {
				...
				// deoarece nr_senatori e o variabila shared, tb sa ma asigur
				// ca nu scriu in ea simultan 2 thread-uri
				#pragma omp critical
